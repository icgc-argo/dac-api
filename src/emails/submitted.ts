...
function messageBody(app: Application) {
  return `
    ...
    ${appInfoBox(app)}
    ${textParagraphSection(
      `Your application is currently locked and not editable online. The ICGC DACO will review your application and you will be notified <strong>within ten business days</strong> concerning the status of your application.`,
    )}
  `;
}
