...
import { actionGetStarted, compose, formatDate, getApplicantName as formatName, infoBox, textParagraphSection, UILinksInfo } from './common';
...
function messageBody(app: Application, uiLinksInfo: UILinksInfo, name: string, addedOn: Date) {
  ...
  return  `
    ${textParagraphSection(`A new collaborator was added to the following application:`, { padding: '0px 0px 5px 0px' })}
