...
import { actionGetStarted, compose, formatDate, getApplicantName, infoBox, textParagraphSection, UILinksInfo } from './common';
...
function messageBody(app: Application, uiLinksInfo: UILinksInfo, letterInfo: { addedOn: Date, }) {
  ...
  return  `
    ${textParagraphSection(`A new ethics letter has been added to the following application:`, { padding: '0px 0px 5px 0px' })}
